...
const styles = StyleSheet.create({
  ...
  hero: { marginHorizontal: 0, marginTop: 0, height: 390, borderBottomLeftRadius: 42, borderBottomRightRadius: 42, overflow: 'hidden', alignItems: 'center', paddingTop: 154 },
  heroImage: { resizeMode: 'cover' },
  heroOverlay: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(0,47,113,0.12)' },
  heroTitle: { color: '#FFFFFF', fontSize: 36, fontWeight: '900', textDecorationLine: 'underline', marginBottom: 20 },
  ...
  motivationCard: { marginHorizontal: 24, marginTop: 20, borderRadius: 18, padding: 14, shadowColor: '#000', shadowOpacity: 0.12, shadowOffset: { width: 0, height: 5 }, shadowRadius: 11, elevation: 4 },
