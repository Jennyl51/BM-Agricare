...
export function getRewardsList() {
  // Temporary no-auth endpoint for backend/RDS rendering test.
  return apiRequest('/demo/rewards', 'GET', null, { useAuth: false });
}

export function getProtectedRewardsList() {
  // Use this later after auth token flow is working.
  return apiRequest('/rewards');
}
